...
create table Rooms (
	...
	RoomFloor SMALLINT,
	DivisionID int CONSTRAINT RoomsDivisionForeign FOREIGN KEY references Divisions ON DELETE no action
);
GO
...
create table Abonents (
	...
	RoomID int CONSTRAINT AbonentsRoomForeign FOREIGN KEY references Rooms ON DELETE no action,
